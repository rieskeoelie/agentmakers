...
const T = {
  nl: {
    ...
    agentsLabel: 'Dit kan uw AI team zijn',
    agentsH2: 'Nooit meer een bericht missen, op elk kanaal',
    agentsSub: 'Telefoon, WhatsApp, Instagram, Facebook, SMS of e-mail. Uw AI agent staat op elk kanaal klaar.',
    agents: makeAgents(
  ...
  en: {
    ...
    steps: [
      ...
      ['4', 'Live within 1 week', 'Your AI agents are running within 1 week, 24/7, without interruption.'],
    ],
    demoBadge: 'Free demo',
    ...
    agentsLabel: 'This could be your AI team',
    agentsH2: 'Never miss a message, on any channel',
    agentsSub: 'Phone, WhatsApp, Instagram, Facebook, SMS or email. Your AI agent is ready on every channel.',
    agents: makeAgents(
  ...
  es: {
    ...
    steps: [
      ...
      ['4', 'En directo en 1 semana', 'Sus agentes de IA funcionan en 1 semana, 24/7, sin interrupciones.'],
    ],
    ...
    agentsLabel: 'Este puede ser su equipo de IA',
    agentsH2: 'Sin perder ningún mensaje, en cada canal',
    agentsSub: 'Teléfono, WhatsApp, Instagram, Facebook, SMS o e-mail. Su agente de IA está listo en cada canal.',
    agents: makeAgents(
      ...
      <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100, background: 'rgba(255,255,255,.92)', backdropFilter: 'blur(12px)', borderBottom: '1px solid #F1F5F9', padding: '16px 0' }}>
        <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <a href="/" style={{ textDecoration: 'none' }}>
            <img src="/logo.svg" alt="agentmakers.io" style={{ height: 36, width: 'auto', display: 'block' }} />
          </a>
