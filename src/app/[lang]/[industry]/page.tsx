  ...
  return (
    <div style={{ fontFamily: "'Nunito', sans-serif", color: '#334155', background: '#fff' }}>
      ...
      <section className="sp" style={{ background: '#F1F5F9' }}>
        <div className="grid-split" style={{ maxWidth: 1120, margin: '0 auto', padding: '0 24px' }}>
          ...
          <div>
            ...
            {/* Labels as row below ring — no overflow */}
            <div style={{ display: 'flex', justifyContent: 'center', gap: 10, marginTop: 18, flexWrap: 'wrap' }}>
              <div style={{ background: '#fff', border: '1.5px solid #0D9488', borderRadius: 10, padding: '6px 14px', fontSize: '.85rem', fontWeight: 600, color: '#0D9488', boxShadow: '0 2px 10px rgba(0,0,0,.08)' }}>
                {l === 'nl' ? 'Ja, we zijn geopend' : l === 'en' ? 'Yes, we are open' : 'Sí, estamos abiertos'}
              </div>
              <div style={{ background: '#fff', border: '1.5px solid #DC5858', borderRadius: 10, padding: '6px 14px', fontSize: '.85rem', fontWeight: 600, color: '#DC5858', boxShadow: '0 2px 10px rgba(0,0,0,.08)' }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'separate', borderSpacing: 0, background: '#fff', borderRadius: 16, overflow: 'hidden', boxShadow: '0 1px 4px rgba(0,0,0,.06)' }}>
              ...
              <tbody>
                {[
                  ...
                  [l === 'nl' ? 'Taalondersteuning' : l === 'en' ? 'Language support' : 'Idiomas', l === 'nl' ? '1–2 talen' : l === 'en' ? '1–2 languages' : '1–2 idiomas', l === 'nl' ? '10+ talen' : l === 'en' ? '10+ languages' : '10+ idiomas'],
      ...
      <footer style={{ background: '#0F172A', color: '#CBD5E1', padding: '40px 0', textAlign: 'center', fontSize: '.85rem' }}>
        <p>© 2026 agentmakers.io. {l === 'nl' ? 'Alle rechten voorbehouden.' : l === 'en' ? 'All rights reserved.' : 'Todos los derechos reservados.'} &nbsp;|&nbsp; <a href={`/${l}/privacy`} style={{ color: '#CBD5E1', textDecoration: 'none' }}>Privacy</a> &nbsp;|&nbsp; <a href={`/${l}/voorwaarden`} style={{ color: '#CBD5E1', textDecoration: 'none' }}>{l === 'nl' ? 'Voorwaarden' : l === 'en' ? 'Terms' : 'Términos'}</a></p>
      </footer>
    </div>
  )
}
