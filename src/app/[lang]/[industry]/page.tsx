        ...
        <div className="grid-split" style={{ maxWidth: 1120, margin: '0 auto', padding: '0 24px' }}>
          ...
          <div>
            <div style={{ width: 260, height: 260, margin: '0 auto', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div style={{ position: 'absolute', top: '50%', right: -24, transform: 'translateY(-50%)', background: '#fff', border: '1.5px solid #DC5858', borderRadius: 10, padding: '6px 14px', fontSize: '.85rem', fontWeight: 600, color: '#DC5858', boxShadow: '0 2px 10px rgba(0,0,0,.1)', whiteSpace: 'nowrap' }}>
