    ...
    nl: {
      ...
      sections: [
        { num: '1', title: 'Wie wij zijn', body: <>
          ...
          <p>Voor vragen over privacy: <strong>E-mail:</strong> <a href="mailto:info@agentmakers.io" style={lnk}>info@agentmakers.io</a></p>
        </> },
        ...
        { num: '3', title: 'Doeleinden van gegevensverwerking', body: <>
          ...
          <div style={hl}>Wij verkopen nooit uw gegevens.</div>
        </> },
        ...
        { num: '9', title: 'Uw rechten (AVG)', body: <>
          ...
          <p>Verzoeken via: <a href="mailto:privacy@agentmakers.io" style={lnk}>privacy@agentmakers.io</a>. Wij reageren binnen 30 dagen.</p>
        </> },
        ...
        { num: '13', title: 'Contact', body: <>
          <p><strong>Agentmakers.io</strong><br />E-mail: <a href="mailto:info@agentmakers.io" style={lnk}>info@agentmakers.io</a></p>
          <p>U heeft ook het recht om een klacht in te dienen bij de <a href="https://www.autoriteitpersoonsgegevens.nl" target="_blank" rel="noopener noreferrer" style={lnk}>Autoriteit Persoonsgegevens</a>.</p>
        </> },
      ],
    },
    en: {
      ...
      sections: [
        { num: '1', title: 'Who we are', body: <>
          ...
          <p>For privacy questions: <strong>Email:</strong> <a href="mailto:info@agentmakers.io" style={lnk}>info@agentmakers.io</a></p>
        </> },
        ...
        { num: '3', title: 'Purposes of data processing', body: <>
          ...
          <div style={hl}>We never sell your data.</div>
        </> },
        ...
        { num: '9', title: 'Your rights (GDPR)', body: <>
          ...
          <p>Requests to: <a href="mailto:privacy@agentmakers.io" style={lnk}>privacy@agentmakers.io</a>. We respond within 30 days.</p>
        </> },
        ...
        { num: '13', title: 'Contact', body: <>
          <p><strong>Agentmakers.io</strong><br />Email: <a href="mailto:info@agentmakers.io" style={lnk}>info@agentmakers.io</a></p>
    ...
    es: {
      ...
      sections: [
        { num: '1', title: 'Quiénes somos', body: <>
          ...
          <p>Consultas de privacidad: <strong>Email:</strong> <a href="mailto:info@agentmakers.io" style={lnk}>info@agentmakers.io</a></p>
        </> },
        ...
        { num: '3', title: 'Finalidades del tratamiento', body: <>
          ...
          <div style={hl}>Nunca vendemos sus datos.</div>
        </> },
        ...
        { num: '9', title: 'Sus derechos (RGPD)', body: <>
          ...
          <p>Solicitudes a: <a href="mailto:privacy@agentmakers.io" style={lnk}>privacy@agentmakers.io</a>. Respondemos en 30 días.</p>
        </> },
